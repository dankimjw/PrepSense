...
def run_migration():
    ...
    migration_file = Path(__file__).parent / 'backend_gateway' / 'migrations' / 'add_user_recipes_status.sql'
    ...
    try:
        # Connect to database
        print(f"Connecting to database at {db_params['host']}:{db_params['port']}/{db_params['database']}...")
