...
All recipes have been checked against your nut and shellfish allergies.""",
        ...
        "pantry_items": [item for item in get_mock_pantry_items_for_crew() if item['product_name'] != 'Expired Bread'],
    ...
    def mock_query(query: str, params: Dict[str, Any]):
        if 'user_pantry_full' in query:
            ...
            return [{
                ...
                'preferences': {
                    'dietary_restrictions': get_mock_user_preferences_for_crew()['dietary_restrictions'],
                    'allergens': get_mock_user_preferences_for_crew()['allergens'],
                    'cuisine_preferences': get_mock_user_preferences_for_crew()['cuisine_preferences'],
                    'cooking_skill': get_mock_user_preferences_for_crew()['cooking_skill'],
                    'max_cooking_time': get_mock_user_preferences_for_crew()['max_cooking_time']
                }
            }]
        return []
