...
class CrewAIOrchestrator:
    ...
    async def handle_user_query(
        ...
        try:
            ...
            if not has_fresh_data:
                ...
                asyncio.create_task(self._warm_user_cache_async(user_id, "query_triggered"))
    ...
    async def batch_warm_cache(
        self, user_ids: List[int], trigger_reason: str = "scheduled"
        ...
        for i in range(0, len(user_ids), batch_size):
            ...
            tasks = [self._warm_user_cache_async(user_id, trigger_reason) for user_id in batch]
        ...
        try:
            ...
            status = {
                ...
                "pantry_cache": {
                    ...
                    "last_updated": (
                        pantry_artifact.last_updated.isoformat() if pantry_artifact else None
                    ),
                ...
                "preference_cache": {
                    ...
                    "last_updated": (
                        preference_artifact.last_updated.isoformat()
