...
class PreferenceTool:
    ...
    def _get_user_preferences(self, user_id: int) -> dict[str, Any]:
        ...
        return {
            ...
            "has_preferences": bool(
                ...
                or preferences.get("allergens")
                or preferences.get("cuisine_preference")
            ),
        }
    ...
    def _apply_dietary_filters(self, user_id: int, **kwargs) -> dict[str, Any]:
        ...
        for recipe in recipes:
            ...
            if is_compatible:
                ...
                filtered_out.append({"recipe": recipe, "reasons": incompatible_reasons})
    ...
    def _apply_allergen_filters(self, user_id: int, **kwargs) -> dict[str, Any]:
        ...
        for recipe in recipes:
            ...
            if not contains_allergens:
                ...
                filtered_out.append({"recipe": recipe, "allergens_found": contains_allergens})
        ...
        for recipe in recipes:
            ...
            for cuisine in recipe_cuisines:
                ...
                for pref_cuisine in cuisine_preferences:
                    if (
                        pref_cuisine.lower() in cuisine_lower
                        or cuisine_lower in pref_cuisine.lower()
                    ):
    ...
    def _score_recipe_preferences(self, user_id: int, **kwargs) -> dict[str, Any]:
        ...
        scores = {"dietary_score": 0, "cuisine_score": 0, "allergen_penalty": 0, "total_score": 0}
        ...
        if cuisine_preferences:
            ...
            if not cuisine_result.get("error") and cuisine_result.get("scored_recipes"):
                scores["cuisine_score"] = cuisine_result["scored_recipes"][0].get(
                    "cuisine_preference_score", 0
                )
        ...
        scores["total_score"] = (
            scores["dietary_score"] + scores["cuisine_score"] + scores["allergen_penalty"]
        )
