...
class RecipeImageService:
    ...
    def __init__(self):
        self.base_image_path = Path("/Users/danielkim/_Capstone/PrepSense/Food Data/kaggle-recipes-with-images/Food Images/Food Images/")
    ...
    async def _optimize_image(self, source_path: Path, target_path: Path, max_size: tuple = (800, 600)) -> bool:
