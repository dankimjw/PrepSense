...
class AIRecipeCacheService:
    ...
    def get_cached_recipes(self, user_id: int, pantry_items: List[Dict], 
                          preferences: Dict, max_recipes: int) -> Optional[Dict[str, Any]]:
    ...
    def cache_recipes(self, user_id: int, pantry_items: List[Dict], 
                     preferences: Dict, recipes: List[Dict], 
                     max_recipes: int, metadata: Optional[Dict] = None):
