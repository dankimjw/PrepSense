...
class IngredientParserService:
    ...
    def _normalize_ingredient_name(self, name: str) -> str:
        ...
        descriptors = [
            ...
            'minced', 'crushed', 'ground', 'whole', 'large', 'small', 'medium',
            'ripe', 'raw', 'cooked', 'peeled', 'seedless', 'boneless', 'skinless',
            'lean', 'extra virgin', 'virgin', 'pure', 'organic', 'unsalted',
            'salted', 'sweetened', 'unsweetened', 'low-fat', 'fat-free',
            'all-purpose', 'self-rising', 'instant', 'quick', 'old-fashioned'
        ]
