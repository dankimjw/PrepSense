...
class IngredientMatcherService:
        ...
        self.ingredient_categories = {
            'proteins': {
                'chicken': [
                    ...
                    'whole chicken', 'chicken drumsticks', 'rotisserie chicken',
                    'chicken tenders', 'ground chicken'
                ],
                'beef': [
                    'ground beef', 'beef steak', 'beef roast', 'beef strips',
                    'sirloin', 'ribeye', 'chuck roast', 'beef tenderloin',
                    'stew meat', 'hamburger meat'
                ],
                'pork': [
                    'pork chops', 'ground pork', 'pork tenderloin', 'bacon',
                    'ham', 'pork shoulder', 'pork belly', 'italian sausage',
                    'breakfast sausage', 'prosciutto'
                ],
                'seafood': [
                    'salmon', 'tuna', 'shrimp', 'cod', 'tilapia', 'halibut',
                    'scallops', 'crab', 'lobster', 'mahi mahi', 'sea bass',
                    'catfish', 'trout', 'sardines'
                ],
                'vegetarian': [
                    'tofu', 'tempeh', 'beans', 'lentils', 'chickpeas',
                    'black beans', 'kidney beans', 'pinto beans', 'white beans',
                    'quinoa', 'eggs', 'paneer', 'seitan'
                ]
            },
            'grains': {
                'rice': [
                    ...
                    'short grain rice', 'instant rice'
                ],
                'pasta': [
                    'spaghetti', 'penne', 'fusilli', 'linguine', 'macaroni',
                    'fettuccine', 'rigatoni', 'angel hair', 'bow tie pasta',
                    'orzo', 'lasagna noodles', 'rotini', 'shells'
                ],
                'bread': [
                    'white bread', 'whole wheat bread', 'sourdough', 'baguette',
                    'ciabatta', 'focaccia', 'naan', 'pita bread', 'tortillas',
                    'rolls', 'english muffins', 'bagels'
                ],
                'other_grains': [
                    'quinoa', 'couscous', 'bulgur', 'farro', 'barley',
                    'millet', 'buckwheat', 'polenta', 'grits'
                ]
            },
            'dairy': {
                'milk': [
                    'whole milk', '2% milk', 'skim milk', 'almond milk',
                    'soy milk', 'oat milk', 'coconut milk', 'cashew milk',
                    'evaporated milk', 'condensed milk', 'buttermilk'
                ],
                'cheese': [
                    'cheddar', 'mozzarella', 'parmesan', 'swiss', 'feta',
                    'gouda', 'brie', 'blue cheese', 'goat cheese', 'ricotta',
                    'cream cheese', 'cottage cheese', 'monterey jack'
                ],
                'yogurt': [
                    'plain yogurt', 'greek yogurt', 'vanilla yogurt',
                    'low-fat yogurt', 'non-fat yogurt', 'coconut yogurt',
                    'soy yogurt', 'kefir'
                ],
                'butter_cream': [
                    'butter', 'margarine', 'heavy cream', 'sour cream',
                    'half and half', 'whipping cream', 'creme fraiche'
                ]
            },
            'vegetables': {
                'leafy': [
                    'lettuce', 'spinach', 'kale', 'arugula', 'romaine',
                    'iceberg lettuce', 'mixed greens', 'collard greens',
                    'swiss chard', 'bok choy', 'cabbage'
                ],
                'root': [
                    'potato', 'sweet potato', 'carrot', 'onion', 'garlic',
                    'beet', 'turnip', 'radish', 'parsnip', 'ginger',
                    'shallot', 'yam'
                ],
                'nightshade': [
                    'tomato', 'bell pepper', 'eggplant', 'chili pepper',
                    'jalapeno', 'poblano', 'cherry tomatoes', 'roma tomatoes'
                ],
                'cruciferous': [
                ...
                'squash': [
                    'zucchini', 'yellow squash', 'butternut squash',
                    'acorn squash', 'pumpkin', 'spaghetti squash'
                ]
            },
            'pantry_staples': {
                'oils': [
                    'olive oil', 'vegetable oil', 'canola oil', 'coconut oil',
                    'sesame oil', 'avocado oil', 'grapeseed oil', 'peanut oil'
                ],
                'vinegars': [
                ...
                'sweeteners': [
                    ...
                    'corn syrup', 'molasses', 'stevia', 'coconut sugar'
                ],
                'flours': [
                    'all-purpose flour', 'whole wheat flour', 'bread flour',
                    'cake flour', 'almond flour', 'coconut flour', 'rice flour'
                ]
            }
        }
    ...
    def _normalize_ingredient_name(self, name: str) -> str:
        ...
        # Remove common words
        remove_words = [
            'fresh', 'frozen', 'canned', 'dried', 'organic', 'large', 'small',
            'medium', 'ripe', 'raw', 'cooked', 'whole', 'ground', 'powdered'
        ]
    ...
    def _find_best_match(
        ...
        best_fuzzy_match = self._fuzzy_match_ingredient(
            ingredient_name, 
            list(pantry_index['by_name'].keys())
        )
    ...
    def calculate_quantity_match(
        self, 
        recipe_quantity: Dict, 
        pantry_quantity: Dict
    ) -> Dict:
        """
