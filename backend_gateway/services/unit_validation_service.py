...
class UnitValidationService:
    ...
    def __init__(self, db_service):
        ...
        self.unit_categories = {
            ...
            'volume_imperial': ['teaspoon', 'tablespoon', 'fluid_ounce', 'cup', 'pint', 'quart', 'gallon'],
        ...
        self.validation_rules = {
            'solid_items_no_liquid': {
                ...
                'forbidden_units': self.unit_categories['volume_metric'] + self.unit_categories['volume_imperial'],
    ...
    async def validate_unit(self, item_name: str, unit: str, 
    ...
    async def suggest_best_unit(self, item_name: str, 
    ...
    async def convert_unit(self, item_name: str, amount: float,
                         from_unit: str, to_unit: str) -> Optional[Dict[str, Any]]:
        """
        ...
        generic_conversion = self._get_generic_conversion(
            from_normalized, to_normalized, amount
        )
    ...
    def _normalize_unit(self, unit: str) -> str:
        ...
        mappings = {
            ...
            'kg': 'kilogram', 'kilo': 'kilogram', 'kilos': 'kilogram', 'kilograms': 'kilogram',
            ...
            'fl oz': 'fluid_ounce', 'fluid oz': 'fluid_ounce', 'fluid ounces': 'fluid_ounce',
            'c': 'cup', 'cups': 'cup',
            'pt': 'pint', 'pints': 'pint',
            ...
            # Containers
            'pkg': 'package', 'packages': 'package', 'pack': 'package',
            'bags': 'bag', 'boxes': 'box', 'cans': 'can',
            'jars': 'jar', 'bottles': 'bottle', 'cartons': 'carton'
        }
        
        return mappings.get(unit_lower, unit_lower)
    
    def _apply_special_rules(self, item_name: str, unit: str, 
                           food_info: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        """Apply special validation rules."""
    ...
    def _enhance_with_quantity_context(self, validation_result: Dict[str, Any],
    ...
    async def _suggest_conversions(self, item_name: str, amount: float,
                                 from_unit: str, to_units: List[str]) -> List[Dict[str, Any]]:
    ...
    def _get_unit_suggestions_by_category(self, category: str, 
    ...
    def _adjust_for_context(self, suggestions: Dict[str, Any],
                          context: str, category: str) -> Dict[str, Any]:
    ...
    async def _get_typical_quantities(self, item_name: str, unit: str) -> Dict[str, float]:
        ...
        typical = {
            'each': {
                'banana': 1, 'apple': 1, 'egg': 12, 'bread': 1
            },
            'pound': {
                'chicken': 2, 'beef': 1, 'apples': 3, 'grapes': 1
            },
            'cup': {
                'milk': 2, 'flour': 2, 'sugar': 1, 'rice': 1
            },
            'package': {
                'cookies': 1, 'crackers': 1, 'cereal bars': 1
            }
        }
        ...
        # Default quantities
        defaults = {
            'each': 1, 'pound': 1, 'kilogram': 0.5,
            'cup': 1, 'liter': 1, 'package': 1
        }
        
        return {unit: defaults.get(unit, 1)}
    
    async def _validate_conversion(self, item_name: str,
                                 from_unit: str, to_unit: str) -> Dict[str, bool]:
        ...
        if (from_category, to_category) in incompatible or \
           (to_category, from_category) in incompatible:
            return {
                'is_valid': False,
    ...
    def _get_generic_conversion(self, from_unit: str, to_unit: str,
