...
async def get_unit_categories() -> Dict[str, Any]:
    ...
    return {
        'produce_fruits': {
            ...
            'allowed_units': ['lb', 'oz', 'kg', 'g', 'each', 'pint', 'quart', 'basket', 'bag', 'container'],
        ...
        'dairy_liquid': {
            ...
            'allowed_units': ['ml', 'l', 'fl oz', 'cup', 'pint', 'quart', 'gallon', 'bottle', 'carton'],
        ...
        'beverages': {
            ...
            'allowed_units': ['ml', 'l', 'fl oz', 'cup', 'pint', 'quart', 'gallon', 'bottle', 'can', 'container'],
...
async def batch_validate_units(
    items: list[UnitValidationRequest],
    db_pool: asyncpg.Pool = Depends(get_db_pool)
) -> Dict[str, Any]:
    """
