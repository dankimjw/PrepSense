...
@router.get("/user/{user_id}/items", response_model=List[Dict[str, Any]], summary="Get Shopping List")
...
@router.post("/remove-items", response_model=Dict[str, Any], summary="Remove Items from Shopping List")
async def remove_shopping_list_items(
    ...
    try:
        ...
        for item_name in request.item_names:
            ...
            result = db_service.execute_query(delete_query, {
                "user_id": request.user_id,
                "item_name": item_name
            })
...
@router.patch("/items/{item_id}", response_model=Dict[str, Any], summary="Update Shopping List Item")
...
@router.delete("/user/{user_id}/clear", response_model=Dict[str, Any], summary="Clear Shopping List")
...
@router.get("/user/{user_id}/summary", response_model=Dict[str, Any], summary="Get Shopping List Summary")
