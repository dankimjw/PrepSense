...
async def get_units(
    category: Optional[str] = Query(None, description="Filter by unit category (mass, volume, count)"),
    ...
    try:
        ...
        units = [
            # Mass units
            Unit(id="g", label="gram", category="mass", to_base_factor=1.0, is_metric=True, display_order=1),
            Unit(id="kg", label="kilogram", category="mass", to_base_factor=1000.0, is_metric=True, display_order=2),
            Unit(id="mg", label="milligram", category="mass", to_base_factor=0.001, is_metric=True, display_order=3),
            Unit(id="oz", label="ounce", category="mass", to_base_factor=28.3495, is_metric=False, display_order=10),
            Unit(id="lb", label="pound", category="mass", to_base_factor=453.592, is_metric=False, display_order=11),
            
            # Volume units
            Unit(id="ml", label="millilitre", category="volume", to_base_factor=1.0, is_metric=True, display_order=1),
            Unit(id="l", label="litre", category="volume", to_base_factor=1000.0, is_metric=True, display_order=2),
            Unit(id="tsp", label="teaspoon", category="volume", to_base_factor=4.92892, is_metric=False, display_order=10),
            Unit(id="tbsp", label="tablespoon", category="volume", to_base_factor=14.7868, is_metric=False, display_order=11),
            Unit(id="cup", label="cup", category="volume", to_base_factor=236.588, is_metric=False, display_order=12),
            Unit(id="floz", label="fluid ounce", category="volume", to_base_factor=29.5735, is_metric=False, display_order=13),
            
            # Count units
            Unit(id="ea", label="each", category="count", to_base_factor=1.0, is_metric=True, display_order=1),
            Unit(id="dozen", label="dozen", category="count", to_base_factor=12.0, is_metric=True, display_order=2),
            Unit(id="head", label="head", category="count", to_base_factor=1.0, is_metric=True, display_order=3),
            Unit(id="bunch", label="bunch", category="count", to_base_factor=1.0, is_metric=True, display_order=4),
            Unit(id="loaf", label="loaf", category="count", to_base_factor=20.0, is_metric=True, display_order=5),
            Unit(id="slice", label="slice", category="count", to_base_factor=1.0, is_metric=True, display_order=6),
            Unit(id="can", label="can", category="count", to_base_factor=1.0, is_metric=True, display_order=7),
            Unit(id="bottle", label="bottle", category="count", to_base_factor=1.0, is_metric=True, display_order=8),
        ]
    ...
    for unit_cat in allowed_categories:
        ...
        if unit_cat == UnitCategory.MASS:
            available_units["mass"] = [
                ...
                Unit(id="kg", label="kilograms", category="mass", to_base_factor=1000.0, display_order=2),
                Unit(id="oz", label="ounces", category="mass", to_base_factor=28.3495, is_metric=False, display_order=10),
                Unit(id="lb", label="pounds", category="mass", to_base_factor=453.592, is_metric=False, display_order=11),
            ]
        elif unit_cat == UnitCategory.VOLUME:
            available_units["volume"] = [
                Unit(id="ml", label="millilitres", category="volume", to_base_factor=1.0, display_order=1),
                Unit(id="l", label="litres", category="volume", to_base_factor=1000.0, display_order=2),
                Unit(id="cup", label="cups", category="volume", to_base_factor=236.588, is_metric=False, display_order=10),
                Unit(id="tsp", label="teaspoons", category="volume", to_base_factor=4.92892, is_metric=False, display_order=11),
                Unit(id="tbsp", label="tablespoons", category="volume", to_base_factor=14.7868, is_metric=False, display_order=12),
            ]
            ...
            available_units["count"] = [
                ...
                Unit(id="dozen", label="dozen", category="count", to_base_factor=12.0, display_order=2),
            ]
            
            # Add category-specific count units
            if category_key == "produce":
                available_units["count"].extend([
                    Unit(id="head", label="head", category="count", to_base_factor=1.0, display_order=3),
                    Unit(id="bunch", label="bunch", category="count", to_base_factor=1.0, display_order=4),
                ])
            elif category_key == "bakery":
                available_units["count"].extend([
                    Unit(id="loaf", label="loaf", category="count", to_base_factor=20.0, display_order=3),
                    Unit(id="slice", label="slice", category="count", to_base_factor=1.0, display_order=4),
                ])
...
async def validate_unit_conversion(
    ...
    unit_categories = {
        ...
        "cup": "volume", "floz": "volume", "pt": "volume", "qt": "volume", "gal": "volume",
        # Count
        "ea": "count", "dozen": "count", "pair": "count", "head": "count",
        "bunch": "count", "loaf": "count", "slice": "count", "can": "count",
        "bottle": "count", "box": "count", "bag": "count"
    }
    ...
    base_factors = {
        ...
        "cup": 236.588, "floz": 29.5735, "pt": 473.176, "qt": 946.353, "gal": 3785.41,
        # Count (to each)
        "ea": 1.0, "dozen": 12.0, "pair": 2.0, "head": 1.0,
        "bunch": 1.0, "loaf": 20.0, "slice": 1.0, "can": 1.0,
        "bottle": 1.0, "box": 1.0, "bag": 1.0
    }
