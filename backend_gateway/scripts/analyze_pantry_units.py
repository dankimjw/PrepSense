...
def analyze_pantry_units():
    ...
    liquid_units = ['ml', 'l', 'liter', 'milliliter', 'gallon', 'quart', 'pint', 'fluid ounce', 'fl oz', 'cup', 'cups']
    solid_items = ['bread', 'cookie', 'chip', 'cracker', 'cake', 'sandwich', 'bar', 'pizza', 'bagel']
    
    weight_units = ['g', 'gram', 'grams', 'kg', 'kilogram', 'oz', 'ounce', 'lb', 'pound', 'pounds']
    count_units = ['each', 'piece', 'pieces', 'item', 'items', 'loaf', 'loaves', 'slice', 'slices', 'bag', 'bags', 'box', 'boxes', 'package', 'packages']
