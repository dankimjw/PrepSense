...
class USDAUnitMappingImporter:
    ...
    def __init__(self, db_url: str):
        ...
        self.conn = None
        self.zip_path = Path(
            "/Users/danielkim/_Capstone/PrepSense/Food Data/FoodData_Central_AllData/FoodData_Central_csv_2025-04-24.zip"
        )
    ...
    async def analyze_category_unit_relationships(self) -> dict[int, dict[str, any]]:
        ...
        category_unit_stats = defaultdict(
            lambda: {"unit_counts": defaultdict(int), "total_foods": 0, "example_foods": []}
        )
    ...
    async def generate_category_unit_rules(self, category_stats: dict[int, dict[str, any]]):
        ...
        for category_id, stats in category_stats.items():
            ...
            sorted_units = sorted(stats["unit_counts"].items(), key=lambda x: x[1], reverse=True)[
                :5
            ]
