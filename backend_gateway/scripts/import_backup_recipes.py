...
class RecipeImporter:
    ...
    def extract_recipe_metadata(self, title: str, instructions: str) -> Dict[str, Any]:
        ...
        if instructions:
            ...
            time_matches = re.findall(r'(\\d+)\\s*(minutes?|mins?|hours?|hrs?)', instructions.lower())
            times = []
                ...
                for recipe in recipes:
                    try:
                        ...
                        """, 
                            ...
                            'local',  # source
                            recipe.image_name,
                            int(recipe.recipe_hash, 16) % 2147483647,  # Convert hash to int for backup_recipe_id
                            json.dumps({
    ...
    def print_summary(self):
        ...
        print(f"Success rate: {(self.stats.successful_imports/self.stats.total_processed*100):.1f}%")
