...
class FoodCategorizationDeployer:
    ...
    async def initialize_food_cache(self):
        ...
        common_items = [
            ...
            ("spinach", None), ("lettuce", None), ("tomato", None),
            
            # Dairy
            ("milk", None), ("cheese", None), ("yogurt", None),
            ("butter", None), ("eggs", None),
            
            # Meat & Seafood
            ("chicken breast", None), ("ground beef", None), ("salmon", None),
            
            # Pantry staples
            ("bread", None), ("rice", None), ("pasta", None),
            ("flour", None), ("sugar", None), ("olive oil", None),
            
            # Snacks
            ("cereal bar", None), ("protein bar", None), ("crackers", None),
...
def main():
    ...
    parser.add_argument(
        '--test-only', 
        action='store_true',
        help='Run tests only without deployment'
    )
