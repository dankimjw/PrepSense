...
def get_default_unit(item_name: str, category: str = None) -> str:
    ...
    if item_category in [FoodCategory.PRODUCE_COUNTABLE, FoodCategory.EGGS, 
                         FoodCategory.BREAD_BAKERY, FoodCategory.BEVERAGES]:
        return Unit.EACH
    
    # Prefer weight for bulk items
    elif item_category in [FoodCategory.PRODUCE_BULK, FoodCategory.MEAT_SEAFOOD,
                           FoodCategory.DRY_GOODS]:
