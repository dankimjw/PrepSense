      ...
      try {
        ...
        if (scanMode === 'items') {
          ...
          try {
            ...
            // For React Native, ensure the file URI is properly formatted
          ...
          // For React Native, we need to ensure the file URI is properly formatted
          // Some platforms need file:// prefix, others don't
          const normalizedUri = photoUri.startsWith('file://') ? photoUri : `file://${photoUri}`;
