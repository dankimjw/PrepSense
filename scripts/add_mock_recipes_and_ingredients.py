...
MOCK_RECIPES = [
    ...
    },
    {
        ...
        "extendedIngredients": [
            ...
            {"name": "chipotle peppers in adobo", "amount": 1, "unit": "can", "aisle": "International"},
    ...
    try:
        ...
        for recipe in MOCK_RECIPES:
            for ingredient in recipe["extendedIngredients"]:
                ...
                if key not in all_ingredients:
                    ...
                    if isinstance(all_ingredients[key]["amount"], (int, float)) and isinstance(ingredient["amount"], (int, float)):
        ...
        for ingredient_key, ingredient_data in all_ingredients.items():
            ...
            try:
                ...
                logger.info(f"Added/Updated pantry item: {ingredient_data['name']} - {quantity_str}")
